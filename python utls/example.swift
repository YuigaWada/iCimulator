...
open class AVCapturePhotoOutput : AVCaptureOutput {
     ...
     */
    open var preparedPhotoSettingsArray: [AVCapturePhotoSettings] { get }
     ...
     */
    open func setPreparedPhotoSettingsArray(_ preparedPhotoSettingsArray: [AVCapturePhotoSettings], completionHandler: ((Bool, Error?) -> Void)? = nil)
     ...
     */
    open var __availablePhotoPixelFormatTypes: [NSNumber] { get }
     ...
     */
    open var availablePhotoCodecTypes: [AVVideoCodecType] { get }
     ...
     */
    open var __availableRawPhotoPixelFormatTypes: [NSNumber] { get }
     ...
     */
    @available(iOS 11.0, *)
    open var availablePhotoFileTypes: [AVFileType] { get }
     ...
     */
    @available(iOS 11.0, *)
    open var availableRawPhotoFileTypes: [AVFileType] { get }
     ...
     */
    @available(iOS 11.0, *)
    open func supportedPhotoPixelFormatTypes(for fileType: AVFileType) -> [NSNumber]
     ...
     */
    @available(iOS 11.0, *)
    open func supportedPhotoCodecTypes(for fileType: AVFileType) -> [AVVideoCodecType]
     ...
     */
    @available(iOS 11.0, *)
    open func supportedRawPhotoPixelFormatTypes(for fileType: AVFileType) -> [NSNumber]
     ...
     */
    @available(iOS 13.0, *)
    open var maxPhotoQualityPrioritization: AVCapturePhotoOutput.QualityPrioritization
     ...
     */
    @available(iOS, introduced: 10.0, deprecated: 13.0)
    open var isStillImageStabilizationScene: Bool { get }
     ...
     */
    @available(iOS 13.0, *)
    open var isVirtualDeviceFusionSupported: Bool { get }
    ...
    open var isDualCameraFusionSupported: Bool { get }
     ...
     */
    @available(iOS 13.0, *)
    open var isVirtualDeviceConstituentPhotoDeliverySupported: Bool { get }
    ...
    open var isDualCameraDualPhotoDeliverySupported: Bool { get }
     ...
     */
    @available(iOS 13.0, *)
    open var isVirtualDeviceConstituentPhotoDeliveryEnabled: Bool
     ...
     */
    @available(iOS 11.0, *)
    open var isCameraCalibrationDataDeliverySupported: Bool { get }
     ...
     */
    @available(iOS 12.0, *)
    open var isAutoRedEyeReductionSupported: Bool { get }
     ...
     */
    open var isFlashScene: Bool { get }
     ...
     */
    @NSCopying open var photoSettingsForSceneMonitoring: AVCapturePhotoSettings?
     ...
     */
    open var isHighResolutionCaptureEnabled: Bool
     ...
     */
    open var maxBracketedCapturePhotoCount: Int { get }
     ...
     */
    open var isLivePhotoCaptureSupported: Bool { get }
     ...
     */
    open var isLivePhotoCaptureEnabled: Bool
     ...
     */
    open var isLivePhotoCaptureSuspended: Bool
     ...
     */
    open var isLivePhotoAutoTrimmingEnabled: Bool
     ...
     */
    @available(iOS 11.0, *)
    open var availableLivePhotoVideoCodecTypes: [AVVideoCodecType] { get }
    ...
    open class func jpegPhotoDataRepresentation(forJPEGSampleBuffer JPEGSampleBuffer: CMSampleBuffer, previewPhotoSampleBuffer: CMSampleBuffer?) -> Data?
     ...
     */
    @available(iOS, introduced: 10.0, deprecated: 11.0)
    open class func dngPhotoDataRepresentation(forRawSampleBuffer rawSampleBuffer: CMSampleBuffer, previewPhotoSampleBuffer: CMSampleBuffer?) -> Data?
}
...
extension AVCapturePhotoOutput {
     ...
     */
    @available(iOS 11.0, *)
    open var isDepthDataDeliverySupported: Bool { get }
     ...
     */
    @available(iOS 12.0, *)
    open var isPortraitEffectsMatteDeliverySupported: Bool { get }
     ...
     */
    @available(iOS 13.0, *)
    open var availableSemanticSegmentationMatteTypes: [AVSemanticSegmentationMatte.MatteType] { get }
 ...
 */
@available(iOS 10.0, *)
open class AVCapturePhotoBracketSettings : AVCapturePhotoSettings {
     ...
     */
    public convenience init(rawPixelFormatType: OSType, processedFormat: [String : Any]?, bracketedSettings: [AVCaptureBracketedStillImageSettings])
     ...
     */
    @available(iOS 11.0, *)
    public convenience init(rawPixelFormatType: OSType, rawFileType: AVFileType?, processedFormat: [String : Any]?, processedFileType: AVFileType?, bracketedSettings: [AVCaptureBracketedStillImageSettings])
     ...
     */
    open var bracketedSettings: [AVCaptureBracketedStillImageSettings] { get }
     ...
     */
    open var isLensStabilizationEnabled: Bool
}
 ...
 */
@available(iOS 10.0, *)
open class AVCaptureResolvedPhotoSettings : NSObject {
     ...
     */
    open var photoDimensions: CMVideoDimensions { get }
     ...
     */
    open var rawPhotoDimensions: CMVideoDimensions { get }
     ...
     */
    open var previewDimensions: CMVideoDimensions { get }
     ...
     */
    @available(iOS 11.0, *)
    open var embeddedThumbnailDimensions: CMVideoDimensions { get }
     ...
     */
    @available(iOS 12.0, *)
    open var rawEmbeddedThumbnailDimensions: CMVideoDimensions { get }
     ...
     */
    @available(iOS 12.0, *)
    open var portraitEffectsMatteDimensions: CMVideoDimensions { get }
     ...
     */
    @available(iOS 13.0, *)
    open func dimensionsForSemanticSegmentationMatte(ofType semanticSegmentationMatteType: AVSemanticSegmentationMatte.MatteType) -> CMVideoDimensions
     ...
     */
    open var livePhotoMovieDimensions: CMVideoDimensions { get }
     ...
     */
    open var isFlashEnabled: Bool { get }
     ...
     */
    @available(iOS 12.0, *)
    open var isRedEyeReductionEnabled: Bool { get }
     ...
     */
    @available(iOS, introduced: 10.0, deprecated: 13.0)
    open var isStillImageStabilizationEnabled: Bool { get }
     ...
     */
    @available(iOS 13.0, *)
    open var isVirtualDeviceFusionEnabled: Bool { get }
     ...
     */
    @available(iOS, introduced: 10.2, deprecated: 13.0)
    open var isDualCameraFusionEnabled: Bool { get }
     ...
     */
    @available(iOS 11.0, *)
    open var expectedPhotoCount: Int { get }
     ...
     */
    @available(iOS 13.0, *)
    open var photoProcessingTimeRange: CMTimeRange { get }
}
...
open class AVCapturePhoto : NSObject {
     ...
     */
    @available(iOS 12.0, *)
    open var portraitEffectsMatte: AVPortraitEffectsMatte? { get }
     ...
     */
    @available(iOS 13.0, *)
    open func semanticSegmentationMatte(for semanticSegmentationMatteType: AVSemanticSegmentationMatte.MatteType) -> AVSemanticSegmentationMatte?
     ...
     */
    open var cameraCalibrationData: AVCameraCalibrationData? { get }
     ...
     */
    open var sourceDeviceType: AVCaptureDevice.DeviceType? { get }
}
...
extension AVCapturePhoto {
     ...
     */
    @available(iOS 12.0, *)
    open func fileDataRepresentation(with customizer: AVCapturePhotoFileDataRepresentationCustomizer) -> Data?
    ...
    open func fileDataRepresentation(withReplacementMetadata replacementMetadata: [String : Any]?, replacementEmbeddedThumbnailPhotoFormat: [String : Any]?, replacementEmbeddedThumbnailPixelBuffer: CVPixelBuffer?, replacementDepthData: AVDepthData?) -> Data?
 ...
 */
@available(iOS 12.0, *)
public protocol AVCapturePhotoFileDataRepresentationCustomizer : NSObjectProtocol {
